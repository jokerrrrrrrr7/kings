...
if edit then EditMsg(msg.chat_id_,msg.id_,'10% - |█    @JT_M_3     |') end
if edit then EditMsg(msg.chat_id_,msg.id_,'20% - |███  @JT_M_3       |') end
download_file('https://raw.githubusercontent.com/حط هنا الرو بتاعك انت/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @JT_M_3     |') end
download_file('https://raw.githubusercontent.com/حط هنا الرو بتاعك انت/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @JT_M_3   |') end
download_file('https://raw.githubusercontent.com/حط هنا الرو بتاعك انت/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @JT_M_3  |') end
download_file('https://raw.githubusercontent.com/حط هنا الرو بتاعك انت/main/inc/functions.lua','./inc/functions.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ws..":NameBot:") or "𝚂𝙾𝚄𝚁𝙲𝙴 J T M"
...
usernn = data.username_ or "JT_M_3"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "JT_M_3"
end
Name = Name:gsub('[[][]]','')
...
var = 'هذا البوت' 
elseif UserID == 1765160742 or UserID == 1866538640 or UserID == 1866538640 then 
var = 'مطور السورس'
...
message = message ..i.. '-l ['..info.username..'](t.me/JT_M_3) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/JT_M_3) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/JT_M_3) l » (`' ..v.. '`) \n'
end
end
end
...
if UserID == 1765160742 or UserID == 1325450849 then return sendMsg(ChatID,MsgID," لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
