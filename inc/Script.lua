...
message = message..' ['..info.username..'](T.ME/JT_M_3)  \n'
...
elseif UserID == 1765160742 or UserID == 1866538640 or UserID == 1836706131 then  
...
elseif  UserID == 1325450849 or UserID == 1765160742  then 
return sendMsg(arg.ChatID,arg.MsgID,"♪   لا يمكنك تقييد مطور السورس\n") 
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"♪  لا يمكنك تقييد المطور الاساسي\n") 
elseif redis:sismember(ws..':SUDO_BOT:',UserID) then 
...
if UserID == 1325450849 or UserID == 1765160742 then return sendMsg(msg.chat_id_,msg.id_,"♪  لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
return '♪ اصدار سورس جي تي ام*v'..version..'* \n'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "♪  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/هنا الموقع/main/GetVersion.txt') or "0"
...
local inline = {{{text="Source Channel : 𝚂𝙾𝚄𝚁𝙲𝙴 J T M",url="T.ME/JT_M_3"}}}
send_key(msg.sender_user_id_,'  [Source : 𝚂𝙾𝚄𝚁𝙲𝙴 J T M ](T.ME/JT_M_3)',nil,inline,msg.id_)
return false
end
...
local text = " [مطور السورس ](t.me/XB0BB)"
local inline = {
{{text = '-𝙳𝙴𝚅',url="https://t.me/XB0BB"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end
...
local inline = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 KINGS ࿊ ',url="https://t.me/Tablkk"}},
...
if not msg.SudoBase then return "♪  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://raw.githubusercontent.com/هنا الموقع/main/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/s0000000adhfkldfkldsjfksdjfkljsdkj0nicX/s0000000adhfkldfkldsjfksdjfkljsdkj0nicX.github.io/main/plugins/"..FileName)
if res == 200 then
...
elseif Text== "hell" or Text== "..." or Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/UU_0px)")
