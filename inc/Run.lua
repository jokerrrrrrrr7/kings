...
if msg.sender_user_id_ == 1765160742 or msg.sender_user_id_ == 1836706131 or msg.sender_user_id_== 1866538640 then 
...
SUDO_USER = redis:hgetall(ws..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(ws..':WELCOME_BOT'),[[مرحبا انا بوت اسمي]]..redis:get(ws..':NameBot:')..[[ 
 اختصاصي حماية المجموعات 
مـن السبام والتكرار والخ...
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1325450849 or msg.sender_user_id_ == 1765160742) then
return sendMsg(msg.chat_id_,msg.id_,"🗂¦ تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1325450849 or msg.sender_user_id_ == 1765160742) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل ") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1325450849 or msg.sender_user_id_ == 1765160742) then
